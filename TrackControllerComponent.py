...
# TRACKS Buttons
		...
		if self.is_enabled():
			if self._prev_track_button != None:
				if self.selected_track_idx > 0:
					self._prev_track_button.set_on_off_values("Mode."+self._skin_name+".On", "Mode."+self._skin_name+".Off")
					self._prev_track_button.turn_on()
				else:
					self._prev_track_button.set_on_off_values("Mode."+self._skin_name+".Off", "Mode."+self._skin_name+".Off")
					self._prev_track_button.turn_off()
			if self._next_track_button != None :
				if self.selected_track_idx < len(self.song().tracks) - 1:
					self._next_track_button.set_on_off_values("Mode."+self._skin_name+".On", "Mode."+self._skin_name+".Off")
					self._next_track_button.turn_on()
				else:
					self._next_track_button.set_on_off_values("Mode."+self._skin_name+".Off", "Mode."+self._skin_name+".Off")
	...
	def update_scene_buttons(self):
		...
		if self.is_enabled():
			if self._prev_scene_button != None:
				self._prev_scene_button.set_on_off_values("Mode."+self._skin_name+".On", "Mode."+self._skin_name+".Off")
			...
			if self._next_scene_button != None:
				self._next_scene_button.set_on_off_values("Mode."+self._skin_name+".On", "Mode."+self._skin_name+".Off")
